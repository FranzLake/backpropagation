function [Eit,Eval,w,b,historico_w,historico_b,epocas_ejecutadas] = mlp(vtf,alpha,maxepoch,minEtrain,valepoch,numval,w,b,mEnt,mVal,tEnt,tVal,handles)
	...
	for epocas_ejecutadas=1:maxepoch+1
        fprintf('epoca %d\n',epocas_ejecutadas);
		if epocas_ejecutadas==maxepoch+1
        ...
        elseif terminar_entrenamiento
            set(handles.mensaje, 'String', 'Se cumplió la condición de Early Stopping');
            break
        elseif mod(epocas_ejecutadas,valepoch) == 0
